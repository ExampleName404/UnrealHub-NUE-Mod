...
**En son sürümü Releases sayfasından indirin**

*Tek tıkla kurulum: İndirin ve saniyeler içinde kullanmaya başlayın!*

## Flow Launcher Entegrasyonu
Üretkenliğinizi daha da artırın! Klavye üzerinden (`Alt + Boşluk`) anında arama ve proje başlatma yapmak için Flow Launcher eklentisi kullanabilirsiniz.
