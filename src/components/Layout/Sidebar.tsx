...
import { LayoutGrid, Settings, Package, KanbanSquare } from 'lucide-react';
...
export type View = 'projects' | 'engines' | 'marketplace' | 'kanban' | 'settings';
    ...
    return (
        <div className={`h-full bg-[#04070d]/60 flex flex-col select-none relative z-20 ${compactMode ? 'w-[72px]' : 'w-60'} ${!reduceAnimations ? 'transition-all duration-300' : ''}`}>
            ...
            <nav className="flex-1 px-3 space-y-1.5">
                ...
                <NavItem view="kanban" currentView={currentView} icon={KanbanSquare} label={t('sidebar.kanban')} reduceAnimations={reduceAnimations} compactMode={compactMode} onViewChange={onViewChange} />
